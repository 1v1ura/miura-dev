...
const Logo = ({styleName}: Props) => (
  <svg viewBox="0 0 300 300" fill="none" xmlns="http://www.w3.org/2000/svg" className={ styleName ? cn(styleName) : 'w-8'}>
    <rect width="300" height="300" fill="#E5E5E5"/>
    <rect x="5" y="5" width="290" height="290" fill="white"/>
    <path d="M0 0H300V300H0V0Z" fill="white"/>
    <path d="M74.6875 187V179.734H93.4844V127.141L75.9531 129.016L75.1094 121.562L95.2188 119.219H102.906V179.734H119.5V187H74.6875Z" fill="black"/>
    ...
    <rect x="5" y="5" width="290" height="290" stroke="black" strokeWidth="10"/>
  </svg>
)
